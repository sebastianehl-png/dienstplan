...
export default function EditRequest({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-lg bg-zinc-50 p-2">
      ...
      <select value={k} onChange={(ev) => setK(ev.target.value as "VACATION" | "SPECIAL" | "WISH")} className="rounded border border-zinc-300 px-2 py-1 text-xs">
        <option value="VACATION">Urlaub</option>
        <option value="SPECIAL">Sonderurlaub</option>
        <option value="WISH">Freiwunsch</option>
      </select>
